        ...
        return (
            <div className="board">
                <div className="title-box">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" stroke="#BDC3C7" strokeWidth="2.5" className="edit-button"
                ...
                <ul className="bookmarks">
                    {
                        this.props.bookmarks.map((bookmark, i) => (
                            <li key={i} className="bookmark">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" stroke="#FFF" strokeWidth="2.5" className="edit-button"
                                    fill="none" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" >
                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                </svg>
                            </li>
